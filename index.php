...
<html>
	...
	<head>
		...
		<meta name="keywords" content="urban, city, planner, designer, design, web, technology, information, maps, mapping, architect, architecture, developer, San Francisco, Bay Area, California" />
		...
		<script src="fonts/Montserrat_400-Montserrat_700.font.js" type="text/javascript"></script>
	...
	<body lang="en">
		...
		<div id="col1">
			<div id="title">
				<h1><a href="http://louhuang.com/"><img src="images/title.png" height="150" alt=""><span>Lou Huang</span></a></h1>
			</div>
						
			<div id="about">
				<div class="text">
					<p>Hi! I'm Lou Huang, a LEED-ND accredited urban designer based in San Francisco and a 2013 Fellow at Code for America. I specialize in <strong>graphic presentation</strong>, planning for <strong>human-centric communities</strong>, and <strong>open data + virtual environments</strong>.</p>
				</div>
			</div>
		...
		<div id="col2">
					...
					<div class="menu-section">			
						...
						<div id="menu-misc" class="menu-row">
							<div class="scroller">					
								...
								<a href="portfolio/portfolio.html#fabboard"><div class="menu-item">
									<img src="portfolio/thumb_fabboard.jpg" width=280 height=180 alt="">
									<div class="caption menu-title">Fabboard</div>
								</div></a>							
						...
						<ul>
							...
							<li>
								<ul>
									...
									<li><a href="portfolio/portfolio.html#fabboard">Fabboard</a></li>
			...
			<div id="d-resume" style="display:none;">
				...
				<div class="resume-left">
					...
					<div class="text">
						<p><strong><a href="http://www.codeforamerica.org/" target="_blank">Code for America</a></strong> <img src="images/extlink.gif" width=9 height=9 alt="">  San Francisco, CA
						<br />Fellow (2013)</p>
						
						<p><strong><a href="http://www.umloud.org/" target="_blank">Ümloud!</a></strong> <img src="images/extlink.gif" width=9 height=9 alt="">  San Francisco, CA
						<br />Art Director (2012)</p>
				...
				<div class="resume-right">
					...
					<div class="text">
					<p>
					<strong>LEED AP</strong>  Neighborhood Development<br />
...
<!--
				<div style="clear: both; padding-top: 10px;" class="text">
					<a href="portfolio/downloads/louhuang_resume.pdf" class="noborder" target="_blank"><img src="images/pdf.png" width=16 height=16 alt="download PDF" title="download PDF"> <span class="note">download resume [pdf]</span></a>
				</div>
// -->				
			</div>
			...
			<div id="d-projects" style="display:none;">
				...
				<div class="current">
					<img src="portfolio/thumb_nerdnite.png" width=280 height=180 alt="" />
					<h3>An Open World (at Nerd Nite SF)</h3>
					<p class="text">
					Urban design and open-world video games have in common environments designed for
					activities and exploration.  To create these spaces, video games have reimagined existing
					cities, inspired new ones, or copied them entirely, and many have even
					improved on certain experiences.  What can the real world learn from these virtual environments?
					How can we engage gamers in the development of the physical built environment? 
					(Video of talk coming soon!)
					<a href="http://sf.nerdnite.com/2012/06/12/nerd-nite-sf-25-video-games-urban-design-death-proof-cities-and-the-science-of-futurama/" target="_blank">View site</a> <img src="images/extlink.gif" width=9 height=9 alt="">
					</p>
				</div>

				<div class="current">
					<img src="portfolio/thumb_umloud.png" width=280 height=180 alt="" />
					<h3>Ümloud!</h3>
					<p class="text">
					Annual Rock Band night at DNA Lounge in San Francisco to raise money for Child's Play charity.
					<a href="http://umloud.org/" target="_blank">View site</a> <img src="images/extlink.gif" width=9 height=9 alt="">
					</p>
				</div>
				
				<div class="current">
					<img src="portfolio/thumb_sunnydale.jpg" width=280 height=180 alt="" />
				...
				<div class="current">
					<img src="portfolio/thumb_2175market.jpg" width=280 height=180 alt="" />
					<h3>2175 Market</h3>
					<p class="text">
				...
				<div class="current">
					<img src="portfolio/thumb_sfpopos.jpg" width=280 height=180 alt="" />
					<h3>SFPOPOS</h3>
					<p class="text">
			...
			<div id="d-contact" style="display:none;">
				...
				<p class="text">
				<h3>E-mail</h3>
				<a href="mailto:lou@louhuang.com">lou@louhuang.com</a>
